...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($acao === 'cadastrar') {
        ...
        try {
            ...
            $sql = "INSERT INTO fornecedores (razao_social, cnpj, email, telefone, status) VALUES (:razao_social, :cnpj, :email, :telefone, 'ativo')";
        ...
        // Lógica de edição (mantida como estava, pois parece correta)
